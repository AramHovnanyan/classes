...
public class Department {
    ...
    public void setEmployees(final Employee[] employees){ this.employees = employees; }

    public Employee getDepartmentHeadEmployee(){ return departmentHeadEmployee; }
    public void setDepartmentHeadEmployee(final Employee departmentHeadEmployee){ this.departmentHeadEmployee = departmentHeadEmployee; }

    public double getDepartmentSalary(){ return departmentSalary; }
    public void setDepartmentSalary(final double departmentSalary){ this.departmentSalary = departmentSalary; }
